...
router.post(
  "/movies/:movieId/watchList",
  isAuth,
  movieController.moviesWatchList
);
/**
 * @swagger
 * /user/watchList:
 *   get:
 *     summary: Obține watchlist-ul utilizatorului
 *     description: Returnează lista de filme din watchlist-ul utilizatorului autentificat.
 *     tags: [user]
 *     responses:
 *       '200':
 *         description: Lista de filme din watchlist a fost returnată cu succes
 *         content:
 *           application/json:
 *             schema:
 *               type: array
 ...
 */
router.get("/user/watchList", isAuth, movieController.getUserWatchList);
